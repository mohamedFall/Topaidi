...
<title>Topaidi - Inscription</title>
                ...
                <div class="col l4 m8 s12">
                    <form action="" method="POST">
                        <div class="card-panel z-depth-5" style="border-radius: 12px; border-top: 3px solid #2196F3;">
                            ...
                            <p class="center row">Créez votre espace</p>
                        ...
                        <p class="right"><a href="signIn?action=signOn" class="" style="color: inherit !important;" href="">Déjà inscrit ?</a></p>
                    </form>
                </div>
                <div class="col l4 m2 s12"></div>
            </div>
